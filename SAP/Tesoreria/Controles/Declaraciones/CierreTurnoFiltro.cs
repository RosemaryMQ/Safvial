    ...
    public partial class CierreTurnoFiltro : Form
    {
        ...
        private void CierreTurnoFiltro_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.cierreEfectivoDiaSiguienteTableAdapter.Fill(this.sAPDataSetLocal.CierreEfectivoDiaSiguiente, Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.fechaS), Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.fechaUltimaTabulacionN), Convert.ToInt32(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.turnoB));
                this.cierrePDVDiaSiguienteTableAdapter.Fill(this.sAPDataSetLocal.CierrePDVDiaSiguiente, Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.fechaS), Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.fechaUltimaTabulacionN), Convert.ToInt32(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.turnoB));
                this.cierrePINCDiaSiguienteTableAdapter.Fill(this.sAPDataSetLocal.CierrePINCDiaSiguiente, Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.fechaS), Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.fechaUltimaTabulacionN), Convert.ToInt32(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.turnoB));
                this.cierreTransfDiaSiguienteTableAdapter.Fill(this.sAPDataSetLocal.CierreTransfDiaSiguiente, Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.fechaS), Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.fechaUltimaTabulacionN), Convert.ToInt32(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.turnoB));
                this.cierreBiopagoDiaSiguienteTableAdapter.Fill(this.sAPDataSetLocal.CierreBiopagoDiaSiguiente, Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.fechaS), Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.fechaUltimaTabulacionN), Convert.ToInt32(SAP.Tesoreria.Controles.Declaraciones.VersionV2.GenerarCierre.turnoB));
