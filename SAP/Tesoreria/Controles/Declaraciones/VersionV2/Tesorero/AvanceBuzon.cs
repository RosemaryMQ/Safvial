    ...
    public partial class AvanceBuzon : Form
    {
        ...
        public void CargarAvances()
        {
            ...
            while (dr.Read())
            {
                ...
                BDLista.Rows.Add(dr["ID_Cierre"].ToString(), dr["BilleteBD025"].ToString(), dr["BilleteBD05"].ToString(), dr["BilleteBD1"].ToString(), dr["BilleteBD5"].ToString(), dr["BilleteBD10"].ToString(), dr["BilleteBD20"].ToString(), dr["BilleteBD50"].ToString(), dr["BilleteBD100"].ToString(), dr["Eliminado"].ToString(), "EDITAR");
            }
            dr.Close();
