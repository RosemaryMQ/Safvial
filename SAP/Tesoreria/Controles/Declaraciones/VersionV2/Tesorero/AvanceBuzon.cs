...
namespace SAP.Tesoreria.Controles.Declaraciones.VersionV2.Tesorero
{
    public partial class AvanceBuzon : Form
    {
        ...
        double pd = 0, credito = 0, debito = 0, efectiv = 0, incidenci = 0, Transferencia = 0, total = 0, biopago = 0; 
        public AvanceBuzon()
        {
            InitializeComponent();
