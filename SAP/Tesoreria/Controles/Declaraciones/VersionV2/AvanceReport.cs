...
namespace SAP.Tesoreria.Controles.Declaraciones.VersionV2
{
    public partial class AvanceReport : Form
    {
        ...
        {
            int turno = Convert.ToInt32(SAP.Tesoreria.Controles.ListaDeclaraciones.turno);
            try
            {
                ...
                this.efectivoCierreTableAdapter.Efectivo(this.sAPDataSet.EfectivoCierre, SAP.Tesoreria.Controles.ListaDeclaraciones.ID_Usuario, Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.AvancesRealizados.fechab1), Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.AvancesRealizados.fechab2), "Efectivo", turno);
                this.pDVCierreTableAdapter.PDV(this.sAPDataSet.PDVCierre, SAP.Tesoreria.Controles.ListaDeclaraciones.ID_Usuario, Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.AvancesRealizados.fechab1), Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.AvancesRealizados.fechab2), "Punto de Venta", turno);
                ...
                this.noPagoCierreTableAdapter.NoPago(this.sAPDataSet.NoPagoCierre, SAP.Tesoreria.Controles.ListaDeclaraciones.ID_Usuario, Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.AvancesRealizados.fechab1), Convert.ToDateTime(SAP.Tesoreria.Controles.Declaraciones.VersionV2.AvancesRealizados.fechab2), "Pago Incompleto", turno);
